...
void Framebuffer::DrawPoint(int x, int y, const color_t& color)
{
    ...
    uint8_t invAplpha = 255 - alpha;
    color_t& destColor = ((color_t*)(colorBuffer.data))[x + y * colorBuffer.width];
    destColor.r = ((color.r * alpha) + (destColor.r * invAplpha)) >> 8 ;
    destColor.g = ((color.g * alpha) + (destColor.g * invAplpha)) >> 8 ;
    destColor.b = ((color.b * alpha) + (destColor.b * invAplpha)) >> 8 ;
